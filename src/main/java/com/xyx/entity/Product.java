...
public class Product extends BasedEntity{
    ...
    public Product(Integer id, Integer categoryId, String itemType,
                   String title, String sellPoint, Long price, Integer num,
                   String image, Integer status, Integer priority) {
        this.id = id;
