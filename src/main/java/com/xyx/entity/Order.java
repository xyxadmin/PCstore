...
public class Order extends BasedEntity implements Serializable {
    ...
    public Order(String createdUser, Date createdTime, String modifiedUser, Date modifiedTime, Integer oid, Integer uid, String recvName, String recvPhone, String recvProvince, String recvCity, String recvArea, String recvAddress, Long totalPrice, Integer status, Date orderTime, Date payTime) {
